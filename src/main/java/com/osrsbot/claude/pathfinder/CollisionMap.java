...
/**
 * Collision map with directional walkability checks.
 * Uses 2 flags per tile: flag 0 = can-move-north, flag 1 = can-move-east.
 * South/west are derived from the adjacent tile's north/east flag.
 * Diagonals require both cardinal directions to be clear.
 *
